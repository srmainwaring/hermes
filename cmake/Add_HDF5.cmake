...
find_package(HDF5 ${HDF5_FIND_TAG} COMPONENTS C CXX HL)
...
if (HDF5_FOUND)
    ...
    if (BUILD_SHARED_LIBS)
        ...
        target_link_libraries(hdf5_cpp-shared INTERFACE ${HDF5_LIBRARIES} ${HDF5_CXX_LIBRARIES} ${HDF5_HL_LIBRARIES})
    else ()
        ...
        target_link_libraries(hdf5_cpp-static INTERFACE ${HDF5_LIBRARIES} ${HDF5_CXX_LIBRARIES} ${HDF5_HL_LIBRARIES})
    endif ()
