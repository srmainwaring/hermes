  ...
  class PrintSerializer : public Serializer {
    ...
    class InitVisitor : public SerializationVisitor<PrintSerializer> {
      ...
      inline void visit(FieldBase *field) {
        fmt::format_to(m_serializer->m_w, "  * {:>10s} ({:^5s}) : {:50s}\n",
   ...
   public:
    ...
    void Send(const Message *msg) override {
      std::cout << fmt::to_string(m_w);
      m_w.clear();
    }

   private:
    fmt::memory_buffer m_w;
  ...
  class CSVSerializer : public Serializer {
   ...
   private:
    ...
    class InitVisitor : public SerializationVisitor<CSVSerializer> {
      ...
      inline void visit(FieldBase *field) {
        fmt::format_to(m_serializer->m_w, "{}{}", field->GetName(), m_serializer->m_delimiter);
      }
     ...
     public:
      ...
      void visit(const Field<Eigen::Matrix<double, 3, 1>> *field) override {
        ...
        fmt::format_to(m_serializer->m_w, "{}{}{}{}{}{}",
    ...
    class UnitLineVisitor : public SerializationVisitor<CSVSerializer> {
      ...
      inline void visit(FieldBase *field) {
        fmt::format_to(m_serializer->m_w, "{}{}", field->GetUnit(), m_serializer->m_delimiter);
      }
    ...
    class SerializeVisitor : public SerializationVisitor<CSVSerializer> {
     ...
     public:
      ...
      void visit(const Field<int> *field) override {
        fmt::format_to(m_serializer->m_w, "{:d}{:s}", field->GetData(), m_serializer->m_delimiter);
      }

      void visit(const Field<float> *field) override {
        fmt::format_to(m_serializer->m_w, "{:.12g}{:s}", field->GetData(), m_serializer->m_delimiter);
      }
      ...
      void visit(const Field<std::string> *field) override {
        fmt::format_to(m_serializer->m_w, "{:s}{:s}", field->GetData(), m_serializer->m_delimiter);
      }

      void visit(const Field<Eigen::Matrix<double, 3, 1>> *field) override {
        auto vector = field->GetData();
        fmt::format_to(m_serializer->m_w, "{:.12g}{:s}{:.12g}{:s}{:.12g}{:s}",
