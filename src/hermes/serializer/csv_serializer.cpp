...
namespace hermes {
  ...
  class CSVSerializer::InitVisitor : public SerializationVisitor<CSVSerializer> {
    ...
    inline void visit(FieldBase *field) {
      fmt::format_to(m_serializer->m_impl->m_buffer, "{}{}", field->GetName(), m_serializer->m_impl->m_delimiter);
    }
   ...
   public:
    ...
    void visit(const Field<Eigen::Matrix<double, 3, 1>> *field) override {
      ...
      fmt::format_to(m_serializer->m_impl->m_buffer, "{}{}{}",
    ...
    void visit(const Field<std::vector<double>> *field) override {
      ...
      auto name = field->GetName();
      for (int i = 0; i < n; i++) {
        fmt::format_to(m_serializer->m_impl->m_buffer, "{}_{}{}", name, i, m_serializer->m_impl->m_delimiter);
      }
    }
  ...
  class CSVSerializer::UnitLineVisitor : public SerializationVisitor<CSVSerializer> {
    ...
    inline void visit(FieldBase *field) {
      fmt::format_to(m_serializer->m_impl->m_buffer, "{}{}", field->GetUnit(), m_serializer->m_impl->m_delimiter);
    }
   ...
   public:
    ...
    void visit(const Field<Eigen::Matrix<double, 3, 1>> *field) override {
      ...
      fmt::format_to(m_serializer->m_impl->m_buffer, "{}{}{}", unit_, unit_, unit_);
    }
    ...
    void visit(const Field<std::vector<double>> *field) override {
      ...
      for (int i = 0; i < n; i++) {
        fmt::format_to(m_serializer->m_impl->m_buffer, "{}{}", unit_, m_serializer->m_impl->m_delimiter);
      }
    }
  ...
  class CSVSerializer::SerializeVisitor : public SerializationVisitor<CSVSerializer> {
   ...
   public:
    ...
    void visit(const Field<int> *field) override {
      fmt::format_to(m_serializer->m_impl->m_buffer, "{:d}{:s}", field->GetData(), m_serializer->m_impl->m_delimiter);
    }

    void visit(const Field<float> *field) override {
      fmt::format_to(m_serializer->m_impl->m_buffer, "{:.{}f}{:s}", field->GetData(), field->precision(),
    ...
    void visit(const Field<std::string> *field) override {
      fmt::format_to(m_serializer->m_impl->m_buffer, "{:s}{:s}", field->GetData(), m_serializer->m_impl->m_delimiter);
    }

    void visit(const Field<Eigen::Matrix<double, 3, 1>> *field) override {
      auto precision = field->precision();
      auto vector = field->GetData();
      fmt::format_to(m_serializer->m_impl->m_buffer, "{:.{}f}{:s}{:.{}f}{:s}{:.{}f}{:s}",
    ...
    void visit(const Field<std::vector<double>> *field) override {
      ...
      for (const auto &element: vector) {
        fmt::format_to(m_serializer->m_impl->m_buffer, "{:.{}f}{}", element, precision, m_serializer->m_impl->m_delimiter);
      }
    }
